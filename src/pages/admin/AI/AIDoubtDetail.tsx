...
export default function AIDoubtDetail() {
	return (
		<DashboardLayout actor="admin" userName="Admin User">
			<div className="space-y-6">
				<div>
					<h1 className="text-3xl font-bold text-gray-900 dark:text-white">AI Doubt Detail</h1>
					<p className="text-gray-500 dark:text-neutral-400 mt-2">
						Detailed analysis of AI-generated doubt resolutions.
					</p>
				</div>
